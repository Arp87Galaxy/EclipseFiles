...
<html lang="zh-CN">
  ...
  <body>
    ...
    <div class="container">
      ...
      <form id="loginForm" action="${APP_PATH}/doLogin.do" method="POST" "form-signin" role="form">

        <h2 class="form-signin-heading"><i class="glyphicon glyphicon-user"></i> 用户登录</h2>
		  <div class="form-group has-success has-feedback">
			<input type="text" class="form-control" id="floginacct" name="loginacct" value="superadmin" placeholder="请输入登录账号" autofocus>${exception.message}
    ...
    function dologin() {
    	...
    	if($.trim(floginacct.val()) == ""){
    		layer.msg("账户不能为空，请输入账户",{time:1000,icon:0,shift:6},function(){
        		floginacct.val("");
        		floginacct.focus();	
    		})
